...
<div class="panel panel-default checkout-step-01">
    	...
    	<h4 class="unicase-checkout-title">
	        <a data-toggle="collapse" class="" data-parent="#accordion" href="#collapseOne">
	          <span class="glow">1</span>My Profile
	        </a>
	     </h4>
    </div>
						    ...
						    <div class="panel-heading">
						      <h4 class="unicase-checkout-title">
						        <a data-toggle="collapse" class="collapsed" data-parent="#accordion" href="#collapseTwo">
						          <span class="glow">2</span>Change Password
						        </a>
						      </h4>
						    </div>
...
<div class="form-group">
			 ...
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
					  ...
					  <button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button">Change </button></form> 
